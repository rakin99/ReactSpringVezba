package com.example.bioskop.config;
...
import com.example.bioskop.auth.RestAuthenticationEntryPoint;
import com.example.bioskop.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and()
				...
				// svim korisnicima dopusti da pristupe putanjama /auth/**, (/bioskop/filmovi)
